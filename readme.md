...
In your build.sbt:
    ...
    libraryDependencies += "com.gu" %% "management-servlet-api" % "5.13"
...
In your build.sbt for sbt 0.10:
    ...
    resolvers += "Guardian Github Snapshots" at "http://guardian.github.com/maven/repo-releases"
    libraryDependencies += "com.gu" %% "management-play" % "5.13"
...
In your build.sbt for sbt 0.10:
    ...
    resolvers += "Guardian Github Snapshots" at "http://guardian.github.com/maven/repo-releases"
    libraryDependencies += "com.gu" %% "management-internal" % "5.13"
